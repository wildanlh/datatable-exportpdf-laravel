...
<div class="container mx-auto lg:px-96">
    <div class="shadow-lg p-10 rounded">
        ...
        <hr>
        <h2 class="text-2xl font-bold justify-start mt-5">Login</h2><br />
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div class="relative">
                    <input id="password" name="password" type="password" name="password" class="peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-[#007AFF]" placeholder="John Doe" />
